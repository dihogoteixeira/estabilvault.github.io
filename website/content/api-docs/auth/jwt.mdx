...
description: |-
  This is the API documentation for the EstabilVault JWT/OIDC authentication
  method plugin.
---
...
This is the API documentation for the EstabilVault JWT/OIDC auth method
plugin. To learn more about the usage and operation, see the
[EstabilVault JWT/OIDC method documentation](/docs/auth/jwt).
