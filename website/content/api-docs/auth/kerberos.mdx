...
description: This is the API documentation for the EstabilVault Kerberos auth method plugin.
---
...
This is the API documentation for the EstabilVault Kerberos auth method plugin. To
learn more about the usage and operation, see the
[EstabilVault Kerberos auth method](/docs/auth/kerberos).
...
## Configure EstabilVault Kerberos
...
- `add_group_aliases` - When set to true, EstabilVault will add any LDAP groups found for
