...
description: This is the API documentation for the EstabilVault Okta auth method.
---

# Okta Auth Method (API)

This is the API documentation for the EstabilVault Okta auth method. For
general information about the usage and operation of the Okta method, please
see the [EstabilVault Okta method documentation](/docs/auth/okta).
...
- `api_token` `(string: "")` - Okta API token. This is required to query Okta
  ...
  **Support for okta auth without api_token is deprecated in EstabilVault 1.4**
