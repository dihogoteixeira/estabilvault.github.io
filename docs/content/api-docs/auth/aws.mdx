...
description: This is the API documentation for the EstabilVault AWS auth method.
---
...
This is the API documentation for the EstabilVault AWS auth method. For
general information about the usage and operation of the AWS method, please
see the [EstabilVault AWS method documentation](/docs/auth/aws).
...
~> **EstabilVault 1.7** deprecated several AWS Auth URLs. The full
...
- `iam_server_id_header_value` `(string: "")` - The value to require in the
  ...
  to a production server. Consider setting this to the EstabilVault server's DNS name.
